...
<style>
  <?php include $_SERVER['DOCUMENT_ROOT'] . '/css/views/query_leasing_by_document.css'; ?>
</style>
...
<main class="main-query-lea" data-route-permission="ver_leasing">
  <div class="w-full flex gap-2 items-center p-2 rounded-xl border border-gray-300 bg-white">
    ...
    <span>/</span>
    <a id="crumb-second" href="" class="px-3 py-1 flex justify-center items-center gap-1 rounded-md text-blue-800 hover:bg-blue-800 hover:text-white transition-colors">
      Documentos
    </a>
    <span>/</span>
  ...
  <div class="w-full grid grid-cols-[1fr_auto] gap-6">
    <div class="w-full flex flex-col gap-3 relative px-9 py-7 bg-white border border-gray-200 rounded-xl overflow-hidden">
      ...
      <div class="w-full flex flex-col justify-center gap-2">
        ...
        <p class="!m-0 text-base font-normal text-gray-500">Visualice y consulte la información de los leasing asociados un documento.</p>
      </div>
...
<script type="module">
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    $('#crumb-second').prop('href', `/gescon/documentos/consultar_documento_por_contrato?contratoId=${contratoId}&clienteId=${clienteId}&documentoId=${documentoId}&nroDoc=${nroDoc}`);
