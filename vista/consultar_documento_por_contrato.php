    ...
    <div class="flex flex-col gap-5 px-9 py-7 bg-white border border-gray-200 rounded-xl relative overflow-hidden">
      ...
      <div id="data-document" class="flex flex-col gap-5">
        ...
        <button
          ...
          <p class="translate-x-4 !m-0 !text-white text-base font-medium">Editar documento</p>
        </button>
        <button
          type="button"
          id="btn-document"
...
<script type="module">
  ...
  document.title = "Administración de documentos | Gescon";
  ...
  $("#btn-edit-con").on("click", () => {
    ...
    window.location.href = `registrar_documentos?formUpd=true&idDocumento=${documentId}`;
  })
