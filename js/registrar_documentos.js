...
async function cargarFilasDesdeLista(lista, checkbox) {
  ...
  for (const [index, data] of lista.entries()) {
    ...
    nuevaFila.innerHTML = `
      <td><input type="text" name="item[]" value="${index + 1}" class="cursor-pointer disabled:bg-gray-100 w-full text-center outline-none text-gray-500 border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px]" readonly></td>
      ...
      <td><input type="text" name="tarifa[]" value="${data.tarifa}" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input"></td>
      <td><input type="text" name="cpk[]" value="${data.cpk}" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input"></td>
      <td><input type="number" name="rm[]" value="${data.rm}" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input"></td>
      <td><input type="number" name="cantidad[]" value="${data.cantidad}" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input"></td>

      <td>
        <input type="text" name="kmAdi[]" value="${data.kmAdicional}" class="disabled:bg-gray-100 w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" ${
          checkbox.checked ? "" : "disabled"
        }>
      </td>

      <td>
        <input type="text" name="duracion[]" value="${data.duracion}" class="disabled:bg-gray-100 w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" ${
          checkbox.checked ? "" : "disabled"
        }>
      </td>

      <td><input type="text" name="compra_veh[]" value="${data.compraVeh}" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input"></td>
      <td><input type="text" name="precio_veh[]" value="${data.precioVeh}" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input"></td>
    ...
    $(nuevaFila).find(".terreno-select").select2({ width: "100%" });
    $(nuevaFila).find(".condicion-select").select2({ width: "100%" });
...
function limpiarCampos() {
  ...
  tbody.innerHTML = ` <tr>
                ...
                <td><input type="number" name="rm[]" class="no-negative w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" value="0" data-tooltip="Recorrido mensual del vehiculo"></td>
                <td><input type="number" name="cantidad[]" class="no-negative w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" value="0" data-tooltip="Cantidad de unidades"></td>
                <td><input type="text" min="0" name="kmAdi[]" class="disabled:bg-gray-100 w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" value="0" data-tooltip="$KM Adicional" disabled></td>
                <td><input type="text" name="duracion[]" class="disabled:bg-gray-100 text-center w-full border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" value="0" data-tooltip="Duracion contrato" disabled></td>
                <td><input type="text" name="compra_veh[]" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" value="" data-tooltip="Precio promedio de la compra del vehiculo"></td>
                <td><input type="text" name="precio_veh[]" class="w-full text-center border-gray-300 px-[10px] py-[11px] text-xs bg-white border-2 rounded-[5px] focus:outline-none focus:border-blue-500 placeholder:text-black/25 tooltip-input" value="" data-tooltip="Precio promedio de la venta del vehiculo"></td>
                <td>
