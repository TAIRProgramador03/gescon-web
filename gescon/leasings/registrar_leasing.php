    ...
    <div class="form-cuerpo flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-3">
        <div class="w-full flex justify-end items-center">
          <button id="openModal" class="btn-vehi cart-dos tooltip-input" data-tooltip="Selecciona las unidades adquiridas"> <strong><i class="fa-solid fa-plus"></i> Vehiculos </strong><img src="/public/img/car-wash.png" alt="Freepik" width="30" height="30" style="position: relative; top: 01px;"></button>
        </div>
      ...
      <div class="butto-form">
        ...
        <button
          ...
          <div
            class="backgroud-spinner bg-green-950 text-white rounded-xl h-14 w-1/4 grid place-items-center absolute left-0 top-0 group-hover:w-full z-[1] duration-500">
