          ...
          render: function (data, type, row) {
            return `
              <div class="w-full flex flex-col gap-2">
                <a href="consultar_permisos_por_rol.php?rolId=${row.id}" class="flex justify-center items-center gap-1 px-3 py-2 rounded bg-cyan-100 border border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-white transition-colors">
