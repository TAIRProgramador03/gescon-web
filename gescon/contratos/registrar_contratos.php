...
<!-- ESTILOS -->
<style>
  <?php include $_SERVER['DOCUMENT_ROOT'] . '/css/views/register_contract.css'; ?>
</style>
            ...
            <table id="tabla-dinamica" class="w-full border-collapse table-fixed whitespace-nowrap text-black !text-xs rounded-md !border-gray-200 overflow-hidden">
              <thead>
                <tr>
                  ...
                  <th class="w-[80px] bg-blue-700 text-white !font-medium z-20 border px-2 py-2">CPK</th>
        ...
        <div class="cbo-registrar body">
          ...
          <button
            ...
            <div
              ...
              <i class="bi bi-pencil-fill icon-btn"></i>
              <div
              class="spinner hidden w-4 h-4 border-2 border-t-blue-500 border-gray-300 rounded-full animate-spin"></div>
            </div>
